#!/bin/bash
# Vanilla CoCoOp — Base-to-Novel evaluation (novel split).
# Usage: sh scripts/cocoop/vanilla_base2new_test.sh <DATASET> <SEED>
# Loads `trainers/cocoop.py`; the registered trainer is `CoCoOp`.
