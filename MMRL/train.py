...
# Vanilla MMRL registers class `MMRL` in TRAINER_REGISTRY.
import trainers.mmrl
import trainers.mmrlpp

# MMRL + SpecPL registers class `MMRLSpecPL` in TRAINER_REGISTRY.
import trainers.mmrl_specpl
...
def extend_cfg(cfg):
    ...
    cfg.TASK = "B2N"  # B2N: base-to-novel, CD: cross-dataset, FS: few-shot
